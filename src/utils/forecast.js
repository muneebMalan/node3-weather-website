...
const forecast = (latitude, longitude, callback) => {
   ...
   request({ url, json:true }, (error, {body}) => {
      if(error){
        ...
        +body.currently.temperature+' degress out. The high today is ' + body.daily.data[0].temperatureHigh+' degress with a low of '
        +body.daily.data[0].temperatureLow+' degress. There is a '+body.currently.precipProbability+'% chance of rain.'
        )
      }
   })
}
